 ...
 *
 * @property-read string $type Type of the entity. Can be 'mention' (@username), 'hashtag' (#hashtag), 'cashtag' ($USD),
 ...
 * 'strikethrough' (strikethrough text), 'code' (monowidth string), 'pre' (monowidth block), 'text_link'
